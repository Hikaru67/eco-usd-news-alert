 ...
 * 4. Groups events into 06:00-to-05:59 alert windows
...
async function fetchAndScheduleAlerts() {
    try {
        ...
        // Step 3: Group events by alert window (06:00 today through 05:59 tomorrow)
        const eventsByDate = {};

        highImpactUSD.forEach((event) => {
            const dateKey = getAlertDateKey(event.date);
